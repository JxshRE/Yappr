...
import { APILogin } from "../api/services/authService";
            ...
            <div className="w-[100%]">
                ...
                <form className="p-5 flex flex-col gap-5" onSubmit={handleSubmit(submitLogin)}>
                    ...
                    <div className="flex flex-row gap-2">
                        ...
                        <button type="button" className="w-[50%] hover:bg-primary-accent cursor-pointer transition duration-50 rounded-md h-[3rem] bg-primary text-foreground ">Register</button>
                    </div>
                </form>
            </div>
        </div>
